...
CKEDITOR.editorConfig = function( config )
{
    ...
    config.toolbar_WB_Simple= [['Bold','Italic','-','NumberedList','BulletedList','-','wbdroplets','wblink','Link','Unlink','-','About']];
