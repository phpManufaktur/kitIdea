						...
						html :
							'<style type="text/css">' +
								...
								'{' +
									...
									'margin-bottom:10px;' +
								'}' +
								'.cke_about_container .lepton_logo' +
								'{' +
									'height:81px;' +
									'background-color:#fff;' +
									'background-image:url(' + CKEDITOR.plugins.get( 'about' ).path + 'dialogs/lepton_logo.png);' +
									'background-position:center; ' +
									'background-repeat:no-repeat;' +
									'margin-bottom:10px;' +
								'}' +
							...
							'<div class="cke_about_container">' +
								...
								'</p>' +
                                '<div class="lepton_logo"></div>' +
								'<p>' +
									lang.wbmoduleinfo + '<br />' + '<br />' +
									'<a href="http://www.lepton-cms.org">LEPTON-cms.org</a>' +
								'</p>' +
							'</div>'
					}
				]
